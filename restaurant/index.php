...
$produtosBebidas = [
    [
        "nome"          => "Coca Cola",
        "descrição"     => "Sinta o sabor de Coca-Cola",
        "preco"         =>  "8.00",
        "imagem"        => "img/cocacola.JPG"
    ],
    [
        "nome"          => "Guaraná Antártica",
        "descrição"     => "Sinta o sabor de Guaraná",
        "preco"         =>  "8.00",
        "imagem"        => "img/guarana.jpg"
    ],
    [
        "nome"          => "Fanta Laranja",
        "descrição"     => "Sinta o sabor de Fanta",
        "preco"         =>  "8.00",
        "imagem"        => "img/fanta.png"
    ],
    [
        "nome"          => "Pepsi",
        "descrição"     => "Pode ser muito bom. Pode ser Pepsi",
        "preco"         =>  "8.00",
        "imagem"        => "img/pepsi.jpg"
    ]
];
    ...
    <main>
        <section class="container-banner">
            <div class="container-texto-banner">
                ...
                <img src="img/logo-serenatto.png" class="logo">
            </div>
        </section>
        ...
        <section class="container-bebidas">
            ...
            <div class="container-bebidas-produtos">
                <?php foreach ($produtosBebidas as $bebida): ?>
                    <div class="container-produto">
                        <div class="container-foto">
